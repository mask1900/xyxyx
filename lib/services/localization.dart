...
class AppLocale extends ChangeNotifier {
  ...
  static final Map<String, List<String>> _strings = {
    ...
    'profile_gdprSettingHint': [
      'AB bölgesindeki kullanıcılar için reklam tercihi; istediğiniz '
          'zaman değiştirebilirsiniz.',
      'Ad preference for users in the EU region; you can change it '
          'anytime.',
      'Настройка рекламы для пользователей из региона ЕС; вы можете '
          'изменить её в любое время.',
    ],
