...
class SoundService {
  ...
  // Kisa sentetik efektlerden farkli olarak, bunlar assets/audio/ altina
  // gomulu gercek mp3 dosyalaridir ve tek, kalici bir player uzerinden
  // dongude (loop) calinir.
