        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // --- GDPR reklam tercihi (SADECE AB/AEA/Isvicre/UK
              // kullanicilarina gosterilir; fikir degistirme imkani) ---
              if (GdprService.instance.isEUUser) ...[
                const SizedBox(height: 16),
                StatefulBuilder(
                  builder: (ctx3, setGdprState) {
                    final personalized = GdprService.instance.adsConsent;
                    return Container(
                      padding: const EdgeInsets.all(12),
                      decoration: BoxDecoration(
                        color: AppColors.tubeGlass,
                          ...
                          Row(
                            children: [
                              ...
                              Switch(
                                ...
                                onChanged: (val) async {
                                  await GdprService.instance
                                      .updateAdsConsent(val);
                                  setGdprState(() {});
                                },
                              ),
                            ],
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 2),
            const Text(
              'Klasik renk sıralama · kendi bölümleri',
              maxLines: 2,
              overflow: TextOverflow.ellipsis,
