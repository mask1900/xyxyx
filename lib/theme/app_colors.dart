...
class AppColors {
  ...
  // Meteor (elmas) para birimi rengi ailesi.
  static const meteorCore = Color(0xFFFFB020);
  static const meteorEdge = Color(0xFFB4432A);
  static const meteorTrail = Color(0xFFFF7A45);
