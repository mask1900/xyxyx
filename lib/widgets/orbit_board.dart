...
class _OrbitPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var i = 0; i < rings.length; i++) {
      ...
      // halka kendi uzerinde yon ipucunu tasiyor.
      ...
      final rightArcPaint = Paint()
        ..style = PaintingStyle.stroke
        ..strokeWidth = isFlashing ? 3.4 : 2.0
        ..color = isFlashing ? AppColors.danger : AppColors.warning.withOpacity(0.55);
      ...
      for (var c = 0; c < n; c++) {
        ...
        if (value == null) {
          ...
          final glow = Paint()
            ..color = AppColors.colorFor(value).withOpacity(0.35)
            ..maskFilter = const MaskFilter.blur(BlurStyle.normal, 4);
